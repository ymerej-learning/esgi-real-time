...
const generateNumberBetween = (minimum, maximum) => Math.floor(Math.random() * (maximum - minimum)) + minimum

const generateLag = () => new Promise(resolve => setTimeout(resolve, generateNumberBetween(0, 5000)))
